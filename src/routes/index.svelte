		...
		<!-- Main -->
			<section id="main" class="flex flex-col">
				...
				<!-- Banner -->
					...
					<section id="banner" class="flex flex-col justify-center items-center bg-black w-full h-64 md:pt-64 pt-48 md:pb-64 pb-32">
						<div class="flex flex-col justify-center items-center">
							...
							<a href='/' on:click={() => animateScroll.scrollTo({element: '#sites', duration: 2000})} class="md:mt-10 mt-2">
