		...
		<!-- Main -->
			<section id="main" class="flex flex-col">
				...
				<!-- Banner -->
					...
					url('https://images.unsplash.com/photo-1576653764709-7d175299e6d9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1189&q=80');">
						<div class="body mt-64 mx-64">
							<div class="md:flex items-center justify-center">
                    			<div class="w-full" style="text-shadow: 0 20px 50px hsla(0,0%,0%,8);">
                        			<h1 class="text-6xl font-bold text-white text-center">Notre Dame</h1>
									<h2 class="text-3xl font-bold text-white text-center">The Most Stunning Gothic Cathedral in The World</h2>
					            </div>
                            </div>
						</div>
						...
						<!--photo-->
							...
							<div class="row-span-1 col-span-1 items-center">
								...
								<p class="text-black text-center px-10">
                                	Conceived in the 12th century, completed in the 14th century, and then modified in the 18th century, the cathedral is the symbol of Christian worship in Paris over the centuries.
                        		</p>

								<p class="text-black text-center px-10 mt-8">
                                	Since it was strongly affected by bad weather and the Revolution, the cathedral threatened to collapse in the 19th century. Buoyed by a resurgence in popularity thanks to Notre-Dame de Paris written by Victor Hugo, the government decided to restore it in the 19th century. 
                        		</p>

								<p class="text-black text-center px-10 mt-8">
                                	Listed as a UNESCO World Heritage Site in 1991, the cathedral is now a Mecca for Christian and the most visited monument in France in 2018. 
                        		</p>
					...
					<section id="time" class="flex flex-col bg-gray-100 grid grid-cols-2 w-full smheight">
						...
						<!--photo-->
							<div class="row-span-1 col-span-1 items-center">
								...
								<p class="text-black px-10 text-xl font-semibold mt-2">CLOSING NOW</p>
								<p class="text-black px-10 mt-2">Because of the incidence of the Notre-Dame Cathedral taking place at Paris on the 15 avril 2019, the building and its surroundings are closed to the public.</p>
							</div>
							<div class="items-center row-span-1 col-span-1">
						...
						<!--photo-->
							...
							<div class="row-span-1 col-span-1 items-center">
								...
								<div class="px-10 mt-2 space-y-2">
									...
									<div class="flex">
										<div class="w-10/12 text-black text-left space-x-1">
											<span class="text-xl font-semibold">GUIDED TOURS</span>
										</div>
										<div class="w-2/12 text-black text-right text-xl font-semibold">
											<span>FREE</span>
										</div>
									</div>
									<div class="flex">
										<div class="w-5/6 text-black text-left font-normal ml-4">
											<span>The tours of the cathedral towers begin from the North Tower and involve climbing a total of 402 stairs. We will also check out the cathedral's 13-ton bell in the South Tower during the tours. 20 visitors are admitted to the towers every 10 minutes, and the last admission is at 6:45 p.m.</span>
										</div>
									</div>		
								...
								<div class="px-10 mt-2 space-y-2">
									<div class="flex">
										<div id="address" class="w-2/5 text-black text-left">
											...
											<p class="font-normal mt-2">Cathédrale Notre-Dame de Paris</p>
											<p class="font-normal">6 Parvis Notre-Dame – Place Jean-Paul II</p>
											<p class="font-normal">75004 Paris</p>
											<p class="text-xl font-semibold mt-8">CONTACT</p>
											<p class="font-normal mt-2">Ph. : 33 / (0)1 42 34 56 10</p>
										</div>
										<div id="way" class="w-3/5 text-black text-left pl-4 border-l-4 border-orange-700">
											<p class="text-xl font-semibold">BY SUBWAY</p>
											<p class="font-normal">lines 4, stop Cité or Saint-Michel </p> 
											<p class="text-xl font-semibold mt-2">BY RER</p>
											<p class="font-normal">line B, C, stop Saint-Michel </p>
                                            <p class="text-xl font-semibold mt-2">BY BUS</p>
											<p class="font-normal">lines 21, 38, 47, or 85</p>
										</div>
									</div>
								</div>
							</div>
